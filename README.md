...
- [demo展示（该demo目前只包括展示，增删改代码尚未上传））](http://121.42.36.80/log-admin/#/url/index/1)，该demo数据来源于Flume+Kafka+Spark Streaming+Redis+MySQL搭建的基于nginx访问日志的数据系统。[系统搭建相关知识点这里](http://www.jianshu.com/p/c2e5c347fe60)
